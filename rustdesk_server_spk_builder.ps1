...
description="Self-hosted open-source ID/Rendezvous and Relay server for RustDesk clients.`nThis package was built with https://github.com/istvanmate/RustdeskServerBuilder4Synology"
arch="{model}"
maintainer="Self"
